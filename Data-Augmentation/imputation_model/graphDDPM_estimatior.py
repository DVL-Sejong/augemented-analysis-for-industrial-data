...
from .lightning_module_graph import GraphTimeGradLightningModule
...
class GraphTimeGradEstimator(PyTorchLightningEstimator):
    """
    ...
    def _create_instance_splitter(self, module: GraphTimeGradLightningModule, mode: str):
    ...
    def create_training_data_loader(
        self,
        data: Dataset,
        module: GraphTimeGradLightningModule,
    ...
    def create_lightning_module(self) -> GraphTimeGradLightningModule:
        return GraphTimeGradLightningModule(
            # loss=self.loss,
            lr=self.lr,
