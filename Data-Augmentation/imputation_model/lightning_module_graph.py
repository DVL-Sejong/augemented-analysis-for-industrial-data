...
from .module import GraphTimeGradModel


class GraphTimeGradLightningModule(pl.LightningModule):
    """
    ...
    def __init__(
        ...
        self.model = GraphTimeGradModel(**model_kwargs)
        self.lr = lr
    ...
    def configure_optimizers(self):
        ...
        monitor = (
            ...
            #    print(self.trainer.fit_loop.epoch_loop.val_loop._data_source.is_defined())
            "train_loss"
        )
